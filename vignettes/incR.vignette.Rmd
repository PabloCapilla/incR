...
author: "Pablo Capilla-Lasheras (pacapilla@gmail.com)"
date: '`r Sys.Date()`'
output: rmarkdown::pdf_document
vignette: |
  %\VignetteIndexEntry{Workflow using the incR package} %\VignetteEngine{knitr::knitr} \usepackage[UTF-8]{inputenc}
---
...
inc.example <- incRscan (data=df.prep,            # data frame
                         ...
                         maxNightVariation=2,     # max night variation accepted in 
                                                  # calibrating windows
