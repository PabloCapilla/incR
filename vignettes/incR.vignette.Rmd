...
incubation behaviour using the *incR* R package and present its functions. This package is
currently available
...
modified), *incR* still provides a suite of functions that allow the extraction of biologically
meaningful metrics from a series of observations of the incubating individual. 
This allows for
the development of *incRscan* without affecting the functionality of the package
as a whole.
...
off-bout, an off-bout comes after a short on-bout (Figure below). To circumvent this problem,
...
*sensitivity* and *temp.diff* work well for blue and great tits in northern latitudes in 
